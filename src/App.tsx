        ...
        <div ref={sections.home} className="min-h-screen bg-navy text-white flex items-center justify-center relative">
          ...
          <div className="relative z-10 text-center px-4">
            ...
            <div className="flex flex-col mt-8 md:flex-row justify-center items-center gap-4 md:gap-6">
              {/* Simple colored rectangular buttons with only name visible */}
              <a
                href="https://www.iittp.ac.in/"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-golden text-navy px-8 py-3 rounded-lg font-bold hover:bg-golden-light transition-colors duration-200 min-w-[220px] text-center shadow-md"
              >
                About IIT Tirupati
              </a>
              <a
